# -*- coding: utf-8 -*-
"""MMVAE_Model_Thesis_Soft_Assignment_USPS_Beta_Factor_Final.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1CouzGJbaO16lCFgkmdPMsdPmxomnHI5p
...
Selected_Accuracy=Accuracy_Posterior[::10]
plt.figure(figsize=(8, 6))
x=np.linspace(10, len(Accuracy_GMM)*10, len(Accuracy_GMM))
y=np.linspace(10, len(Selected_Accuracy)*10, len(Selected_Accuracy))
...
x=np.linspace(10, len(NMI_GMM)*10, len(NMI_GMM))
plt.figure(figsize=(8, 6))
plt.xlabel("Epochs")
...
x=np.linspace(10, len(ARI_GMM)*10, len(ARI_GMM))
plt.figure(figsize=(8, 6))
plt.xlabel("Epochs")
