...
Model="Beta_MVAE_EM"
Assignment="Hard"
Model_name= f"{Model}_{random_seed}_Latent_dim_{latent_dim}_{Assignment}_Optimization_{initial_beta_1}_Beta_{beta_1}_{Dataset_name}"
...
for epoch in range(num_epochs):
  if epoch == 0:
    ...
    beta = initial_beta_1 - annealing_schedule_beta * epoch
    beta = max(beta, beta_1)
  ## Training Step
  model.train()
  ...
  for training_features, _ in train_loader:
    ...
    ELBO_Train=RE_Train-beta*KL_Train
  ...
  with torch.no_grad():
    for test_features, test_labels in test_loader:
      ...
      ELBO_Test=RE_Test-beta*KL_Test
    ...
    if (epoch+1)%GMM_interval ==0:
        ...
        \t LR: {scheduler.get_last_lr()[0]:0.6f} \t Beta: {beta:0.2f}")
