# -*- coding: utf-8 -*-
"""MMVAE_Model_Thesis_Soft_Assignment_Fashion_MNIST_Beta_Factor_Final.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1YBQEHTThHRQwJJuQdtjJjPK3iE4tfm48

# **Modified Mixtures of VAE Model using Fashion-MNIST Dataset**
"""
...
cmap = plt.get_cmap('rainbow', len(np.unique(Updated_GMM_Labels[-1])))
...
latent_tsne = tsne.fit_transform(latent_space_recoded)
plt.figure(figsize=(10, 10))
cmap = plt.get_cmap('rainbow', len(np.unique(Updated_Posterior_Labels[-1])))
...
with torch.no_grad():
  ...
  plt.imshow(new_image)
  plt.axis('off')
  plt.savefig(f'Generated_Image_{Model_name}_{random_seed}_GMM_MD_Prior.png')
  plt.close()
...
with torch.no_grad():
  ...
  plt.imshow(new_image)
  plt.axis('off')
  plt.savefig(f'Generated_Image_{Model_name}_{random_seed}_GMM_MD.png')
  plt.close()
