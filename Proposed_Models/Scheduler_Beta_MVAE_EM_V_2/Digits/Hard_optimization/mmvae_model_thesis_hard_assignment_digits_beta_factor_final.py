# -*- coding: utf-8 -*-
"""MMVAE_Model_Thesis_Hard_Assignment_Digits_Beta_Factor_Final.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/166iMXTESIw167vZTBB3qgPlgAr7mCk0e
...
for epoch in range(num_epochs):
  ...
  with torch.no_grad():
    for test_features, test_labels in test_loader:
      ...
      #   normalized_probability = [value / q_denominator_test for value in q_numerator]
...
print(f"Experiment Completed on Model: {Model_name}")

# content_folder = '/content/'
# extensions = ('.txt', '.pdf', '.png')
# files_to_include = [file for file in os.listdir(content_folder) if file.endswith(extensions)]
# zip_filename = f"/content/f"{Model}_random_seed_{random_seed}_Latent_dim_{latent_dim}_{Assignment}_Optimization_Beta_{beta_1}_{Dataset_name}_dataset.zip"
