# -*- coding: utf-8 -*-
"""MMVAE_Model_Thesis_Updated_Hard_Assignment_Fashion_MNIST.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1yhP_FMy1iyOGHp-eIxBcQJZlcFrt2S4k
...
Model="MMVAE"
Assignment="Hard"
Model_name= f"{Model}_random_seed_{random_seed}_Latent_dim_{latent_dim}_{Assignment}_Optimization_{Dataset_name}_dataset"
...
with torch.no_grad():
  ...
  plt.imshow(new_image)
  plt.axis('off')
  plt.savefig(f'Generated_Image_{Model_name}_{Dataset_name}_{random_seed+4}_GMM_diag.png')
  plt.close()
