# -*- coding: utf-8 -*-
"""MMVAE_Model_Thesis_Updated_Soft_Assignment_Digits_RE_KL_Loss.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/15c62pn5RL7-zaPIxjhN0BG6axVIo2S2e
...
# print(B)
# C = torch.tensor([[0.10, 0.50, 0.40], [0.50, 0.10, 0.40], [0.10, 0.40, 0.50], [0.10, 0.40, 0.50], [0.10, 0.40, 0.50]])
# best_k = torch.argmax(C, dim=1)
# print(best_k)

# D= B[torch.arange(B.size(0)), best_k, :]
# print(D)
...
plt.legend(loc="best")
plt.grid()
plt.savefig(f"{Model_name}_{Dataset_name}_Losses_Training.pdf", format="pdf", bbox_inches="tight")
plt.close()
...
plt.grid()
plt.savefig(f"Negative_KL_Loss_Train_{Model_name}_{Dataset_name}.pdf", format="pdf", bbox_inches="tight")
plt.close()
...
plt.grid()
plt.savefig(f"Negative_RE_Loss_Train_{Model_name}_{Dataset_name}.pdf", format="pdf", bbox_inches="tight")
plt.close()
...
plt.legend(loc="best")
plt.grid()
plt.savefig(f"{Model_name}_{Dataset_name}_Losses_Test.pdf", format="pdf", bbox_inches="tight")
plt.close()
...
plt.grid()
plt.savefig(f"Negative_KL_Loss_Test_{Model_name}_{Dataset_name}.pdf", format="pdf", bbox_inches="tight")
plt.close()
...
plt.grid()
plt.savefig(f"Negative_RE_Loss_Test_{Model_name}_{Dataset_name}.pdf", format="pdf", bbox_inches="tight")
plt.close()
...
with open(f'KL_Loss_Training_{Model_name}_{Dataset_name}.txt', 'w') as file:
  for loss10 in KL_Loss_Train:
        file.write(str(loss10) + '\n')

with open(f'RE_Loss_Training_{Model_name}_{Dataset_name}.txt', 'w') as file:
    for loss11 in RE_Loss_Train:
        file.write(str(loss11) + '\n')

with open(f'KL_Loss_Test_{Model_name}_{Dataset_name}.txt', 'w') as file:
  for loss12 in KL_Loss_Test:
        file.write(str(loss12) + '\n')

with open(f'RE_Loss_Test_{Model_name}_{Dataset_name}.txt', 'w') as file:
...
Selected_Accuracy=Accuracy_Posterior[::5]
plt.figure(figsize=(8, 6))
