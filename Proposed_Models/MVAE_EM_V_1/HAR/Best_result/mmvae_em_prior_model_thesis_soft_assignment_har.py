# -*- coding: utf-8 -*-
"""MMVAE_EM_Prior_Model_Thesis_Soft_Assignment_HAR.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1x99OG5fTTbsBfxGXbaIQwFkX61Q-TNb4

# **Modified Mixtures of VAE Model (EM with Prior) using HAR Dataset**
"""
...
with open(f'Summary_Statistics_Training_{Dataset_name}.txt', 'w') as file:
    ...
    file.write(f"Shape of the First Training Example: {trainset[0][0].shape}\n")
...
with open(f'Summary_Statistics_Test_{Dataset_name}.txt', 'w') as file:
    ...
    file.write(f"Shape of the First Test Example: {testset[0][0].shape}\n")
